...
{
    switch (value) {
        case SMCRSChipFamily::SeaIslands     : return "Sea Islands";
        case SMCRSChipFamily::SouthernIslands: return "Southern Islands";
        case SMCRSChipFamily::VolcanicIslands: return "Volcanic Islands";
        case SMCRSChipFamily::ArcticIslands  : return "Arctic Islands";
        case SMCRSChipFamily::Raven          : return "Raven";
        case SMCRSChipFamily::Navi           : return "Navi";
